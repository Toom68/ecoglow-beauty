export default function ProductsPage() {
  ...
  return (
    <main style={{ maxWidth: "1100px", margin: "0 auto", padding: "3rem 2rem" }}>
      ...
      <p style={{ color: "#666", marginBottom: "3rem" }}>Curated eco-friendly beauty products products for environmentally conscious consumers, primarily women aged 18-45</p>
        ...
        {products.map((p: string, i: number) => (
          <div key={i} style={{ border: "1px solid #eee", borderRadius: "12px", overflow: "hidden" }}>
            ...
            <div style={{ padding: "1.5rem" }}>
              ...
              <p style={{ color: "#666", fontSize: "0.875rem", marginBottom: "1rem" }}>High quality eco-friendly beauty products product. Loved by environmentally conscious consumers, primarily women aged 18-45.</p>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <span style={{ fontWeight: 700, color: "var(--primary)" }}>$10-$50</span>
