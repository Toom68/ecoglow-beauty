export default function HomePage() {
  const products = ["bamboo makeup brushes","reusable makeup remover pads","natural ingredient skincare sets"];
    ...
    <main>
      ...
      <section style={{ background: "var(--primary)", color: "#fff", padding: "6rem 2rem", textAlign: "center" }}>
        ...
        <p style={{ fontSize: "1.2rem", maxWidth: "600px", margin: "0 auto 2rem", opacity: 0.9 }}>
          Discover sustainable beauty products that care for you and the planet.
        </p>
        <a
          href="/products"
      ...
      <section style={{ padding: "4rem 2rem", maxWidth: "1100px", margin: "0 auto" }}>
        <h2 style={{ textAlign: "center", fontSize: "2rem", fontWeight: 700, marginBottom: "3rem" }}>Why EcoGlow Beauty?</h2>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "2rem" }}>
          {["Premium Quality", "Fast Shipping", "100% Satisfaction Guarantee"].map((f) => (
            <div key={f} style={{ padding: "2rem", border: "1px solid #eee", borderRadius: "12px", textAlign: "center" }}>
              ...
              <p style={{ color: "#666" }}>We stand behind every product we sell, made for environmentally conscious consumers, primarily women aged 18-45.</p>
            </div>
          ))}
        </div>
      </section>
            ...
            {products.map((p: string, i: number) => (
              <div key={i} style={{ background: "#fff", border: "1px solid #eee", borderRadius: "12px", overflow: "hidden" }}>
                ...
                <div style={{ padding: "1.5rem" }}>
                  ...
                  <p style={{ color: "#666", marginBottom: "1rem", fontSize: "0.9rem" }}>Perfect for environmentally conscious consumers, primarily women aged 18-45</p>
